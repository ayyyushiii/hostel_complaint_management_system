...
<head>
    ...
    <style>
        ...
        .error-code { font-size: 80px; font-weight: 800; color: #dc3545; margin-bottom: 20px; }
    </style>
</head>
<body>
    <div class="error-container">
        ...
        <p class="text-muted mb-4">Something went wrong on our end. We're working on fixing it.</p>
        <div class="alert alert-light border text-start small mb-4">
            <strong>Error Details:</strong> <%= exception != null ? exception.getMessage() : "Unknown Error" %>
        </div>
        <a href="<%= request.getContextPath() %>/login.jsp" class="btn btn-outline-secondary px-4 py-2">
